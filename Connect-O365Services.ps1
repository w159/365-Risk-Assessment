    ...
    Foreach ($Service in $RequiredServices) {
        ...
        Switch ($Service) {  
            ...
            ExchangeOnline {
                ...
                If ($null -ne (Get-EXOMailbox -ResultSize 1)) {
            ...
            MSOnline {
                ...
                If ($null -ne (Get-MsolUser -MaxResults 1)) {
                    if ($ConnectedServices -ne "") {
                        $ConnectedServices = $ConnectedServices + ","
                    }
                ...
                if (($RequiredServices -contains "SharePoint") -eq "true") {
                    $SharePointHostName = ((Get-MsolDomain) | Where-Object { $_.IsInitial -eq "True" } ).name -split ".onmicrosoft.com"
            ...
            AzureAD {
                ...
                If ($null -ne (Get-AzureADUser -Top 1)) {
                    if ($ConnectedServices -ne "") {
                        $ConnectedServices = $ConnectedServices + ","
                    }
